...
verifyext2fs() {
  ...
  printf("\nSUPERBLOCK\n-------------------------\n - nblocks:          %d\n - ninodes:          %d\n - ngroups:          %d\n - inodes_per_group: %d\n - # free inodes:    %d\n - # free blocks:    %d\n",
          sp->s_blocks_count, sp->s_inodes_count, (int)sp->s_free_inodes_count/sp->s_inodes_per_group, sp->s_inodes_per_group, sp->s_free_inodes_count, sp->s_free_blocks_count);
}
